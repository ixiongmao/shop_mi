...
function userLogin()
{
  ...
  var is_success = frm.elements['is_success'].value;
  var msg = '';
...
//     var sms_code_sign = $('#sms_code_sign').val();
//     $.ajax({
//       type: "POST",
//       url: "http://www.leishen.cn/user.php",
//       data: {'act':'sign','sms_code_sign':sms_code_sign },
//       dataType: "json",
//       success: function(data){
//         if(data.error >0){
//             layer.msg(data.message);
//         }else{
//           $(".sign-top-button").css("background","url(http://www.leishen.cn/themes/xiaomi/images/sign/yiqiandao.png) no-repeat");
//           $('.sign-top-button_conter .text-yelow').text(data.pay_points_1);
//           $('.sign-day .sign-day-btn h3').text('明天签到');
//           $('.sign-day .sign-num strong em').text(data.pay_points_t);
//         }
//       }
//     });
//   })
//   $(".signin_success .t1 a").mousemove(function(){
//     $(".t2").slideDown(900)
//   });
//   $(".signin_success .t1 a").mouseleave(function(){
//     $(".t2").slideUp()
//   });
//
// })
