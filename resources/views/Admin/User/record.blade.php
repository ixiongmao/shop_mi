                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                              @foreach ($data as $k => $v)
                                <tr>
                                    <td>{{ $v->u_name }}</td>
                                    <td><a href="/admin/user/record/list/{{ $v->id }}?Record=dlrecord" class="btn btn-outline btn-default btn-sm">点击查看用户登录记录</a></td>
                                    <td><a href="/admin/user/record/list/{{ $v->id }}?Record=collect" class="btn btn-outline btn-default btn-sm">点击查看用户收藏</a></td>
                                    <td><a href="/admin/user/record/list/{{ $v->id }}?Record=balance" class="btn btn-outline btn-default btn-sm">点击查看用户消费记录</a></td>
                                </tr>
                                @endforeach
                              </tbody>
                        </table>
