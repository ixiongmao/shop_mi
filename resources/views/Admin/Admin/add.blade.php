                            ...
                            <form action="/admin/admin/store" method="post">
                              ...
                              <div class="form-group">
                                  ...
                                  <label class="checkbox-inline">
                                      <input type="checkbox" name="a_permission[]" value="0" checked>无权限</label>
                                  <label class="checkbox-inline">
                                      <input type="checkbox" name="a_permission[]" value="1">分类管理</label>
                                  <label class="checkbox-inline">
                                      <input type="checkbox" name="a_permission[]" value="2">商品管理</label>
                                  <label class="checkbox-inline">
                                      <input type="checkbox" name="a_permission[]" value="3">用户管理</label>
                              </div>
