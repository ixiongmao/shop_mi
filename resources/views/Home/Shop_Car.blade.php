                        ...
                        <div class="item-box">
                            <div class="item-table">
                                <div class="item-row clearfix">
                                    ...
                                    <input type="hidden" id="taocanwu" name="meal_price_wu" value="5">
                                    @if($v['meal_detail'])
                                      <input type="hidden" id="taocan" name="meal_price" value="{{ $v['meal_price'] }}">
                                    @endif
                                    @if(time()>$va['goods_sales_start'] && time() <$va[ 'goods_sales_end'])
                                      <div class="col col-price">{{ $va['goods_sales_price'] }}</div>
                                    @else
                                ...
                                <div class="col col-total" name="tal">{{ $v['total_price'] }}</div>
                                <!-- 计算数量 -->
                                <script>
                                $.ajaxSetup({
                                        headers: {
